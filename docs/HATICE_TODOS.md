...
- `labels.txt` sirasi: model output indeksleri ile birebir ayni 20 kelime.
...
- Hatice ile `543 landmark / 250 sınıf` model kontratının final eğitim kontratı olduğu doğrulanmalı.
